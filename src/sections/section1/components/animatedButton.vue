...
const props = defineProps({
  ...
  successGradientFrom: {
    type: String,
    default: 'oklch(69% 0.17 162)',
    validator: (value) => value.includes('oklch(')
  },
  successGradientTo: {
    type: String,
    default: 'oklch(58% 0.16 163)',
    validator: (value) => value.includes('oklch(')
  },
...
<template>
  <button
      ...
      :class="[
        ...
        'px-3 min-[300px]:px-5 sm:px-7 py-1 min-[300px]:py-1.5 min-w-[120px] min-[300px]:min-w-[150px] w-full flex-1',
        'text-xs min-[300px]:text-sm sm:text-base 2xl:text-lg font-semibold',
  ...
  >
    <div
        :class="[
          ...
          isHovered || showSuccess ? 'w-5 min-[300px]:w-7' : 'w-0'
        ]"
    >
      <div
          :class="[
            'w-4 h-4 min-[300px]:w-5 min-[300px]:h-5 mr-1 min-[300px]:mr-2 transition-all duration-300 ease-out',
            isHovered || showSuccess
      ...
      >
        <svg
            :class="[
              'w-4 h-4 min-[300px]:w-5 min-[300px]:h-5 transition-transform duration-300 ease-in-out',
    ...
    <span
        class="break-words transition-all duration-300 ease-out text-center"
