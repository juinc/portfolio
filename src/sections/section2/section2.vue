...
<template>
  <section id="section-2" class="relative overflow-visible lg:overflow-hidden min-h-screen 2xl:h-screen">
    <div
        class="relative mx-auto max-w-screen-2xl grid gap-6
             w-[90vw] sm:w-[90vw] md:w-[90vw] lg:w-[90vw] xl:w-[90vw] 2xl:w-[70vw]
             min-h-0 md:h-screen md:grid-rows-[auto_minmax(0,1fr)]
             lg:grid-cols-2 lg:items-stretch lg:gap-8 lg:h-[70vh] lg:absolute lg:top-1/2 lg:-translate-y-1/2
             min-md:absolute 2xl:top-1/2 min-md:left-1/2 min-md:-translate-x-1/2 2xl:-translate-y-1/2
             2xl:h-[87vh] 2xl:grid-cols-2 2xl:gap-15"
    >
      ...
      <div class="min-h-0 flex flex-col lg:h-full">
        ...
        >
          ...
          <div
              class="flex-1 min-h-0 dark:border dark:border-(--border-muted) overflow-y-auto overscroll-contain
                   rounded-4xl p-3 sm:p-4 bg-none max-h-full scrollbar-hide flex flex-col gap-2
